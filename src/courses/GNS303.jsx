  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: "11px", letterSpacing: "4px", color: "#94a3b8", marginBottom: "6px", textTransform: "uppercase" }}>
          GNS 303 · Use of English
        </div>
      ...
      <div style={{ padding: "16px 16px 8px", maxWidth: "680px", margin: "0 auto" }}>
        ...
        <div onClick={() => setFlipped(f => !f)} style={{
          minHeight: "280px",
          background: flipped ? `linear-gradient(135deg, ${color}18, ${color}08)` : "linear-gradient(135deg, rgba(255,255,255,0.04), rgba(255,255,255,0.02))",
          ...
          <div style={{ display: "inline-block", padding: "4px 12px", borderRadius: "12px", fontSize: "11px", fontWeight: 700, background: color + "22", color, letterSpacing: "0.5px", marginBottom: "16px" }}>
          ...
          {!flipped ? (
            ...
            <div>
              <div style={{ fontSize: "11px", color, marginBottom: "10px", letterSpacing: "2px" }}>ANSWER</div>
        ...
        {flipped && !answered && (
          <div style={{ display: "flex", gap: "12px", marginTop: "16px" }}>
            <button onClick={() => handleScore(false)} style={{ flex: 1, padding: "12px", borderRadius: "12px", border: "1px solid rgba(248,113,113,0.3)", background: "rgba(248,113,113,0.08)", color: "#f87171", fontSize: "14px", fontWeight: 700, cursor: "pointer" }}>
              ✗ Missed it
            </button>
            <button onClick={() => handleScore(true)} style={{ flex: 1, padding: "12px", borderRadius: "12px", border: "1px solid rgba(74,222,128,0.3)", background: "rgba(74,222,128,0.08)", color: "#4ade80", fontSize: "14px", fontWeight: 700, cursor: "pointer" }}>
              ✓ Got it!
            </button>
          </div>
        )}
        ...
        <div style={{ display: "flex", gap: "12px", marginTop: "16px", marginBottom: "24px" }}>
          <button onClick={prev} style={{ flex: 1, padding: "14px", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.1)", background: "rgba(255,255,255,0.04)", color: "#94a3b8", fontSize: "16px", cursor: "pointer", fontWeight: 700 }}>
            ← Prev
          </button>
          <button onClick={resetAll} style={{ padding: "14px 16px", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.08)", background: "transparent", color: "#475569", fontSize: "11px", cursor: "pointer", letterSpacing: "1px" }}>
            RESET
          </button>
          <button onClick={next} style={{ flex: 1, padding: "14px", borderRadius: "12px", border: `1px solid ${color}44`, background: `${color}15`, color, fontSize: "16px", cursor: "pointer", fontWeight: 700 }}>
            Next →
          </button>
        </div>
